    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="kechengId" name="kechengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="选课编号" prop="xuankeUuidNumber">
                       <el-input v-model="ruleForm.xuankeUuidNumber"
                                 placeholder="选课编号" clearable  :readonly="ro.xuankeUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="选课编号" prop="xuankeUuidNumber">
                           <el-input v-model="ruleForm.xuankeUuidNumber"
                                     placeholder="选课编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    xueshengId: false,
                    kechengId: false,
                    xuankeUuidNumber: false,
                    insertTime: false,
                },
                ruleForm: {
                    xueshengId: '',
                    kechengId: '',
                    xuankeUuidNumber: new Date().getTime(),
                    insertTime: '',
                },
                kechengOptions : [],
                xueshengOptions : [],
