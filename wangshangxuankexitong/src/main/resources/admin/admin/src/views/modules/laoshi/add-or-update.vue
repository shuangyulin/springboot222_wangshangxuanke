               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="擅长" prop="laoshiShanchang">
                       <el-input v-model="ruleForm.laoshiShanchang"
                                 placeholder="擅长" clearable  :readonly="ro.laoshiShanchang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="所获荣誉" prop="laoshiRongyu">
                       <el-input v-model="ruleForm.laoshiRongyu"
                                 placeholder="所获荣誉" clearable  :readonly="ro.laoshiRongyu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="老师介绍" prop="laoshiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.laoshiContent" label="老师介绍" prop="laoshiContent">
                            <span v-html="ruleForm.laoshiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   laoshiRongyu: [
                              { required: true, message: '所获荣誉不能为空', trigger: 'blur' },
                          ],
                   laoshiContent: [
