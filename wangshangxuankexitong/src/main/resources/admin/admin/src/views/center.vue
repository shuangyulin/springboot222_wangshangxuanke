  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='laoshi'"  label='擅长' prop="laoshiShanchang">
               <el-input v-model="ruleForm.laoshiShanchang"  placeholder='擅长' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='laoshi'"  label='所获荣誉' prop="laoshiRongyu">
               <el-input v-model="ruleForm.laoshiRongyu"  placeholder='所获荣誉' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="24">
             <el-form-item v-if="flag=='laoshi'"  label="老师介绍" prop="laoshiContent">
                 <editor
                         style="min-width: 200px; max-width: 600px;"
                         v-model="ruleForm.laoshiContent"
                         class="editor"
                         action="file/upload">
                 </editor>
             </el-form-item>
...
// 注册表 学生 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.laoshiShanchang)&& 'laoshi'==this.flag){
                             this.$message.error('擅长不能为空');
                             return
                         }

                         if((!this.ruleForm.laoshiRongyu)&& 'laoshi'==this.flag){
                             this.$message.error('所获荣誉不能为空');
                             return
                         }

                         if((!this.ruleForm.laoshiContent)&& 'laoshi'==this.flag){
                             this.$message.error('老师介绍不能为空');
                             return
                         }
